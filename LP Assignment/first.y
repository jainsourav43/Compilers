...
IF '(' exp ')' EOL '{' EOL statements EOL '}' EOL ELSE EOL '{' EOL statements EOL '}'{cout<<"Else\n";}


|IF '(' exp ')' EOL '{' EOL statements EOL '}'{	
												$$=getFreeIndex();
												...
												string gen = "if " + table[$3].place + "== " + "0" +" goto " + table[$$].after+'\n';
												table[$$].code = gen+table[$8].code+'\n';
