...
/*#define YY_USE_CLASS 
*/
/*  A Bison++ parser, made from calci.y  */
...
const int YY_parse_CLASS::MOD=264;
const int YY_parse_CLASS::AND=265;
const int YY_parse_CLASS::OR=266;
const int YY_parse_CLASS::XOR=267;
const int YY_parse_CLASS::POW=268;
const int YY_parse_CLASS::EOL=269;
...
static const short yyprhs[] = {     0,
    ...
    29,    33,    35,    39,    43,    47,    49,    53,    55
};

static const short yyrhs[] = {    -1,
    15,    16,    14,     0,    17,     0,    16,    11,    17,     0,
    18,     0,    17,    12,    18,     0,    19,     0,    18,    10,
    22,     0,    20,     0,    19,     4,    20,     0,    19,     5,
    20,     0,    21,     0,    20,     6,    21,     0,    20,     7,
    21,     0,    20,     9,    21,     0,    22,     0,    22,    13,
    21,     0,     3,     0,     8,    22,     0
};
...
static const short yyrline[] = { 0,
    ...
    33,    35,    36,    37,    38,    41,    42,    44,    45
};

static const char * const yytname[] = {   "$","error","$illegal.","NUMBER","ADD",
"SUB","MUL","DIV","ABS","MOD","AND","OR","XOR","POW","EOL","calclist","bitor",
"bitxor","bitand","exp","factor","powterm","term",""
};
#endif

static const short yyr1[] = {     0,
    15,    15,    16,    16,    17,    17,    18,    18,    19,    19,
    19,    20,    20,    20,    20,    21,    21,    22,    22
};
...
static const short yydefact[] = {     1,
     0,    18,     0,     0,     3,     5,     7,     9,    12,    16,
    19,     0,     2,     0,     0,     0,     0,     0,     0,     0,
     0,     4,     6,     8,    10,    11,    13,    14,    15,    17,
     0,     0
};
...
static const short yypact[] = {-32768,
     1,-32768,    -1,    -8,    -7,    -2,     6,    11,-32768,    10,
-32768,    -1,-32768,    -1,    -1,    -1,    -1,    -1,    -1,    -1,
    -1,    -7,    -2,-32768,    11,    11,-32768,-32768,-32768,-32768,
    19,-32768
};

static const short yypgoto[] = {-32768,
-32768,    12,    13,-32768,     5,    -5,    -3
};
...
static const short yytable[] = {    11,
    31,     2,    12,     2,    14,    13,     3,    15,     3,    16,
    17,    24,    27,    28,    29,    30,    18,    19,    32,    20,
    25,    26,    21,    22,     0,     0,    23
};

static const short yycheck[] = {     3,
     0,     3,    11,     3,    12,    14,     8,    10,     8,     4,
     5,    15,    18,    19,    20,    21,     6,     7,     0,     9,
    16,    17,    13,    12,    -1,    -1,    14
};
...
case 4:
#line 23 "calci.y"
{ yyval = yyvsp[-2] | yyvsp[0]; printf("%d  OR  %d\n", yyvsp[-2],yyvsp[0]);;
    break;}
case 6:
#line 26 "calci.y"
{ yyval = yyvsp[-2] ^ yyvsp[0]; printf("%d  XOR  %d\n", yyvsp[-2],yyvsp[0]);;
    break;}
case 8:
#line 29 "calci.y"
{ yyval = yyvsp[-2] & yyvsp[0]; printf("%d  AND  %d\n", yyvsp[-2],yyvsp[0]);;
    break;}
case 10:
#line 32 "calci.y"
{ yyval = yyvsp[-2] + yyvsp[0]; printf("%d  PLUS  %d\n", yyvsp[-2],yyvsp[0]);;
    break;}
case 11:
#line 33 "calci.y"
{ yyval = yyvsp[-2] - yyvsp[0];printf("%d  MINUS  %d\n", yyvsp[-2],yyvsp[0]) ;
    break;}
case 13:
#line 36 "calci.y"
{ yyval = yyvsp[-2] * yyvsp[0];printf("%d  MULT  %d\n", yyvsp[-2] ,yyvsp[0]);
    break;}
case 14:
#line 37 "calci.y"
{ yyval = yyvsp[-2] / yyvsp[0];printf("%d  DIVI  %d\n", yyvsp[-2] ,yyvsp[0]) ;
    break;}
case 15:
#line 38 "calci.y"
{ yyval = yyvsp[-2] % yyvsp[0];printf("%d  MOD  %d\n", yyvsp[-2] ,yyvsp[0]) ;
    break;}
case 17:
#line 42 "calci.y"
{ yyval = powe(yyvsp[-2],yyvsp[0]);printf("%d  POW  %d\n", yyvsp[-2] ,yyvsp[0]) ;
    break;}
case 19:
#line 45 "calci.y"
