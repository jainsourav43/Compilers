...
{
  "$end", "error", "$undefined", "add", "sem", "AND", "OR", "NOT",
  "number", "'-'", "'('", "')'", "'*'", "'%'", "$accept", "lines", "line",
  "exp", "factor2", "factor", YY_NULLPTR
};
#endif
...
{
      12,    -7,    12,     0,    -7,    10,    -1,    -7,    -2,    -7,
      -7,    12,    -7,    12,    -6,    -6,    -6,    -6,    -7,    -1,
      -1,    -7,    -7,    -7,    -7
};
...
{
       9,    11,     1,     0,    14,    15,    10,    13,     1,    18,
       2,    16,    17,    11,    12,    21,    22,    23,    24,    13,
       1,     8,     2,     0,    19,     0,    20
};

static const yytype_int8 yycheck[] =
{
       0,     3,     8,    -1,     5,     6,     3,     9,     8,    11,
      10,    12,    13,     3,     4,    14,    15,    16,    17,     9,
       8,     2,    10,    -1,    11,    -1,    13
};
...
{
       0,     8,    10,    15,    16,    17,    18,    19,    17,     0,
      16,     3,     4,     9,     5,     6,    12,    13,    11,    18,
      18,    19,    19,    19,    19
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 4:
#line 16 "hexy.y" /* yacc.c:1646  */
    {printf("result is %s\n",(yyvsp[-1].a_number));}
#line 1231 "y.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 18 "hexy.y" /* yacc.c:1646  */
    {(yyval.a_number) = (yyvsp[0].a_number);}
#line 1237 "y.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 19 "hexy.y" /* yacc.c:1646  */
    {
    											//printf("%s $1  %s $3\n",$1,$3);
    											to_hex(to_decimal((yyvsp[-2].a_number))+to_decimal((yyvsp[0].a_number)),(yyval.a_number));}
#line 1245 "y.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 22 "hexy.y" /* yacc.c:1646  */
    {
    												to_hex(to_decimal((yyvsp[-2].a_number))-to_decimal((yyvsp[0].a_number)),(yyval.a_number));
    											}
#line 1253 "y.tab.c" /* yacc.c:1646  */
  ...
  case 8:
#line 26 "hexy.y" /* yacc.c:1646  */
    {(yyval.a_number)=(yyvsp[0].a_number);}
#line 1259 "y.tab.c" /* yacc.c:1646  */
    break;

  case 9:
#line 27 "hexy.y" /* yacc.c:1646  */
    {(yyval.a_number) = (yyvsp[-1].a_number);}
#line 1265 "y.tab.c" /* yacc.c:1646  */
    break;

  case 10:
#line 28 "hexy.y" /* yacc.c:1646  */
    {
    												to_hex(to_decimal((yyvsp[-2].a_number))*to_decimal((yyvsp[0].a_number)),(yyval.a_number));
    								}
#line 1273 "y.tab.c" /* yacc.c:1646  */
  ...
  case 11:
#line 31 "hexy.y" /* yacc.c:1646  */
    {to_hex(to_int((yyvsp[-2].a_number)) & to_int((yyvsp[0].a_number)),(yyval.a_number));}
#line 1279 "y.tab.c" /* yacc.c:1646  */
    break;

  case 12:
#line 32 "hexy.y" /* yacc.c:1646  */
    {to_hex(to_int((yyvsp[-2].a_number)) | to_int((yyvsp[0].a_number)),(yyval.a_number));}
#line 1285 "y.tab.c" /* yacc.c:1646  */
    break;

  case 13:
#line 33 "hexy.y" /* yacc.c:1646  */
    {to_hex(to_int((yyvsp[-2].a_number)) % to_int((yyvsp[0].a_number)),(yyval.a_number));
